...
var (
	...
	oemID      = OEMID{Value: B64Url{0xff, 0xff, 0xff}}
	cwtID      = []byte{0xff, 0xff, 0xff, 0xff, 0xff, 0xff}
	nonceBytes = []byte{
...
func TestEat_Full_RoundtripCBOR(t *testing.T) {
	...
	*/
	expected := []byte{
		...
		0xad, 0xbe, 0xef, 0x19, 0x01, 0x02, 0x43, 0xff, 0xff, 0xff, 0x19,
		0x01, 0x05, 0x18, 0x3c, 0x19, 0x01, 0x06, 0xf5, 0x19, 0x01, 0x07,
		0x01, 0x19, 0x01, 0x08, 0xa2, 0x01, 0xfb, 0x40, 0x28, 0xae, 0x14,
		0x7a, 0xe1, 0x47, 0xae, 0x02, 0xfb, 0x40, 0x4c, 0x63, 0xd7, 0x0a,
		0x3d, 0x70, 0xa4,
	}
